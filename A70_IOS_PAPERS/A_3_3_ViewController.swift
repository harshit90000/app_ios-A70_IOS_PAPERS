...
class A_3_3_ViewController: UIViewController {
    ...
    @IBAction func btnd(_ sender: Any) {
        lblans.text="Congratulations, you won 6 lacs"
        self.performSegue(withIdentifier: "q4segue", sender: self)
    }
